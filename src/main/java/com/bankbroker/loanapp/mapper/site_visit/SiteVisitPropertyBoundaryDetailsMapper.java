...
public interface SiteVisitPropertyBoundaryDetailsMapper {
    ...
    SiteVisitPropertyBoundaryDetails toEntity(
    ...
    void updateEntity(
            SiteVisitPropertyBoundaryDetailsRequest request,
            @MappingTarget SiteVisitPropertyBoundaryDetails entity
    );
    ...
    SiteVisitPropertyBoundaryDetailsResponse toResponse(
