...
import com.bankbroker.loanapp.entity.enums.ApplicationStageType;
import com.bankbroker.loanapp.entity.enums.AssignmentType; // New Enum
import jakarta.persistence.*;
import lombok.*;
...
public class LoanApplication {
    ...
    // This usually represents the Agency Admin if assigned to agency
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "assigned_to_id")
    private AdminUser assignedTo;
    ...
    private AssignmentType assignmentType = AssignmentType.AGENCY; // Default to Agency

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "internal_valuator_id")
    private AdminUser internalValuator;
    ...
    // Note: 'valuator' is typically used by the Agency to assign their staff.
    // In 'INTERNAL' mode, you might use 'internalValuator' instead.
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "valuator_id")
    private AdminUser valuator;
    ...
    @Column(name = "assignment_remarks")
